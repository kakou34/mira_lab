...
for i=2:4
    ...
    plot_imgs(1, i, img_fix, img_mov, img_reg)
    file_n = "images\affine_mse_sr.png";
    exportgraphics(gcf,file_n)
end
...
for i=2:4
    ...
    plot_imgs(1, i, img_fix, img_mov, img_reg)
    file_n = "images\rigid_nncc_sr.png";
    exportgraphics(gcf,file_n)
end
...
for i=2:4
    ...
    plot_imgs(1, i, img_fix, img_mov, img_reg)
    file_n = "images\affine_nncc_sr.png";
    exportgraphics(gcf,file_n)
end
...
for i=2:4
    ...
    plot_imgs(1, i, img_fix, img_mov, img_reg)
    file_n = "images\rigid_nngcc_sr.png";
    exportgraphics(gcf,file_n)
end
...
for i=2:4
    ...
    plot_imgs(1, i, img_fix, img_mov, img_reg)
    file_n = "images\affine_nngcc_sr.png";
    exportgraphics(gcf,file_n)
end
